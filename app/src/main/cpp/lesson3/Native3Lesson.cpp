...
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson3_LessonThreeNativeRenderer_nativeSurfaceCreate(JNIEnv *env,
                                                                                     jclass type) {
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson3_LessonThreeNativeRenderer_nativeSurfaceChange(JNIEnv *env,
                                                                                     jclass type,
                                                                                     jint width,
                                                                                     jint height) {
    if (lesson3) {
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson3_LessonThreeNativeRenderer_nativeDrawFrame(JNIEnv *env,
                                                                                 jclass type) {
