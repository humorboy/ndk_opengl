...
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson8_LessonEightNativeRenderer_nativeSurfaceCreate(JNIEnv *env,
                                                                                     jobject instance,
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson8_LessonEightNativeRenderer_nativeSurfaceChange(JNIEnv *env,
                                                                                     jobject instance,
                                                                                     jint width,
                                                                                     jint height) {
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson8_LessonEightNativeRenderer_nativeDrawFrame(JNIEnv *env,
                                                                                 jobject instance) {
    native8Lesson.draw();
}
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson8_LessonEightNativeRenderer_nativeSetDelta(JNIEnv *env,
                                                                                jobject instance,
                                                                                jfloat x,
                                                                                jfloat y) {
