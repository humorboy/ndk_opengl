...
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson5_LessonFiveNativeRenderer_nativeSurfaceCreate(JNIEnv *env,
                                                                                    jclass type,
...
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson5_LessonFiveNativeRenderer_nativeSurfaceChange(JNIEnv *env,
                                                                                    jclass type,
                                                                                    jint width,
                                                                                    jint height) {
...
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson5_LessonFiveNativeRenderer_nativeDrawFrame(JNIEnv *env,
                                                                                jclass type) {
...
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson5_LessonFiveNativeRenderer_nativeSwitchMode(JNIEnv *env,
                                                                                 jclass type) {
