...
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson7_LessonSevenNativeRenderer_nativeToggleStride(JNIEnv *env,
                                                                                    jobject instance) {
    if (lesson7 != nullptr) {
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson7_LessonSevenNativeRenderer_nativeToggleVBOs(JNIEnv *env,
                                                                                  jobject instance) {
    if (lesson7 != nullptr) {
        lesson7->toggleVBOs();
    }
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson7_LessonSevenNativeRenderer_nativeIncreaseCubeCount(
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson7_LessonSevenNativeRenderer_nativeDecreaseCubeCount(
        JNIEnv *env, jobject instance) {
    if (lesson7 != nullptr) {
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson7_LessonSevenNativeRenderer_nativeSetDelta(JNIEnv *env,
                                                                                jobject instance,
                                                                                jfloat x,
                                                                                jfloat y) {
    if (lesson7 != nullptr) {
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson7_LessonSevenNativeRenderer_nativeDrawFrame(JNIEnv *env,
                                                                                 jobject instance) {
    if (lesson7 != nullptr) {
        lesson7->draw();
    }
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson7_LessonSevenNativeRenderer_nativeSurfaceChange(JNIEnv *env,
                                                                                     jobject instance,
                                                                                     jint width,
                                                                                     jint height) {
    if (lesson7 != nullptr) {
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson7_LessonSevenNativeRenderer_nativeSurfaceCreate(JNIEnv *env,
                                                                                     jobject instance,
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson7_LessonSevenNativeRenderer_nativeDestroy(JNIEnv *env,
                                                                               jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson7_LessonSevenNativeRenderer_nativeInit(JNIEnv *env,
                                                                            jobject instance) {
