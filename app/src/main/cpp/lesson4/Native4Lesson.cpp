...
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson4_LessonFourNativeRenderer_nativeSurfaceCreate(JNIEnv *env,
                                                                                    jclass type,
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson4_LessonFourNativeRenderer_nativeSurfaceChange(JNIEnv *env,
                                                                                    jclass type,
                                                                                    jint width,
                                                                                    jint height) {
    if (lesson4) {
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson4_LessonFourNativeRenderer_nativeDrawFrame(JNIEnv *env,
                                                                                jclass type) {
