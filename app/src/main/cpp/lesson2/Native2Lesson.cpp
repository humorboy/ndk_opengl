...
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson2_LessonTwoNativeRenderer_nativeSurfaceCreate(JNIEnv *env,
                                                                                   jclass type) {
    if (native2Lesson) {
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson2_LessonTwoNativeRenderer_nativeSurfaceChange(JNIEnv *env,
                                                                                   jclass type,
                                                                                   jint width,
                                                                                   jint height) {
    if (native2Lesson) {
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson2_LessonTwoNativeRenderer_nativeDrawFrame(JNIEnv *env,
                                                                               jclass type) {
    if (native2Lesson) {
        native2Lesson->draw();
    }
