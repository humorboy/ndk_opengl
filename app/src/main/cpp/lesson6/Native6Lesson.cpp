...
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson6_LessonSixNativeRenderer_nativeSurfaceCreate(JNIEnv *env,
                                                                                   jclass type,
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson6_LessonSixNativeRenderer_nativeSurfaceChange(JNIEnv *env,
                                                                                   jclass type,
                                                                                   jint width,
                                                                                   jint height) {
    if (lesson6) {
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson6_LessonSixNativeRenderer_nativeDrawFrame(JNIEnv *env,
                                                                               jclass type) {
    if (lesson6) {
        lesson6->draw();
    }
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson6_LessonSixNativeRenderer_nativeSetDelta(JNIEnv *env,
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson6_LessonSixNativeRenderer_nativeSetMinFilter(JNIEnv *env,
                                                                                  jclass type,
                                                                                  jint filter) {
    if (lesson6) {
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson6_LessonSixNativeRenderer_nativeSetMagFilter(JNIEnv *env,
                                                                                  jclass type,
                                                                                  jint filter) {
    if (lesson6) {
