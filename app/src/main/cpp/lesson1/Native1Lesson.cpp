...
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson1_LessonOneNativeRenderer_nativeSurfaceCreate(
        JNIEnv *env,
        jclass type) {
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson1_LessonOneNativeRenderer_nativeSurfaceChange(
        JNIEnv *env,
        jclass type,
        jint width,
        jint height) {
...
extern "C"
JNIEXPORT void JNICALL
 Java_com_learnopengles_android_cpp_lesson1_LessonOneNativeRenderer_nativeDrawFrame(
        JNIEnv *env,
        jclass type) {
